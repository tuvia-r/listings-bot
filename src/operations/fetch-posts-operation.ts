...
import { ExtractedPostDetails, extractPostDetails } from '../lib/llm/extract-post-details';
...
async function savePost(post: GroupFeedPost, extractedDetails: ExtractedPostDetails) {
...
export async function fetchPostsOperation(groupId: string, browserInstance: Browser) {
    ...
    logger.info(`Processing complete: ${postCount} posts processed, ${newPostsCount} new posts saved`);
}
