...
const responseSchema = z.object({
    ...
    postSummary: z
        .string()
        .describe(
            `Summary of the post in ${EXTRACT_DETAILS_OUTPUT_LANGUAGE}, this is the text of the post itself, "{type} {size} {location}", it should be in ${EXTRACT_DETAILS_OUTPUT_LANGUAGE}, dont mention the proce, for example: '3 room apartment for rent in Tel Aviv', or 'house for sale in Jerusalem', or 'room for rent in Haifa'`,
        ),
    postDescription: z
        .string()
        .describe(
    ...
    postExtraDetails: z
        ...
        .optional()
        .describe(
            `Extra details of the post in ${EXTRACT_DETAILS_OUTPUT_LANGUAGE}, other important details not covered in the other '${EXTRACT_DETAILS_OUTPUT_LANGUAGE}' fields, if mentioned. keep this short and concise. else null`,
        ),
    postContactInfo: z
        .string()
        .optional()
